...
export const OrderCard = ({
 ...
 className="bg-success-base hover:bg-success-base focus:ring-[var(--color-success)] flex-1 sm:flex-none flex items-center justify-center"
 ...
 className="bg-accent-base hover:bg-accent-base-hover focus:ring-[var(--color-ring)] text-white flex-1 sm:flex-none flex items-center justify-center"
