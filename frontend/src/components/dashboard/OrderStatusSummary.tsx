...
export const OrderStatusSummary = () => {
  ...
  const chartData = [
    {
      name: t("orders.draft", "Draft"),
      value: summary?.draft || 0,
      color: COLORS.draft,
    },
    {
      name: t("orders.confirmed", "Confirmed"),
      value: summary?.confirmed || 0,
      color: COLORS.confirmed,
    },
    {
      name: t("orders.cancelled", "Cancelled"),
  ...
  return (
    <Card>
      ...
      {total === 0 ? (
        <div className="flex items-center justify-center h-[200px] text-sm text-content-tertiary">
