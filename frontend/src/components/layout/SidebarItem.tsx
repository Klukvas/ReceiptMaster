...
export const SidebarItem = ({ href, icon: Icon, label, isActive, isCollapsed, onClick }: SidebarItemProps) => {
 ...
 <div className="px-2.5 py-1.5 text-xs font-medium text-white bg-[#111827] dark:bg-elevated rounded-md shadow-lg whitespace-nowrap">
 {label}
 <div className="absolute right-full top-1/2 -translate-y-1/2 w-0 h-0 border-t-[5px] border-t-transparent border-b-[5px] border-b-transparent border-r-[5px] border-r-[var(--color-text)]" />
 </div>
 </div>
 )}
 </li>
