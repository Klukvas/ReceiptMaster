          ...
          <div className="w-full space-y-3">
            {currentPlan === "free" && (
              <button
                ...
                disabled={!!loading}
                className="w-full flex items-center justify-between p-4 rounded-lg border-2 border-blue-200 dark:border-blue-800 bg-blue-50/50 dark:bg-blue-900/10 hover:border-blue-400 dark:hover:border-blue-600 transition-colors"
              >
