      ...
      <div className="space-y-1">
        ...
        <input
          className={clsx(
            ...
            'focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-0',
