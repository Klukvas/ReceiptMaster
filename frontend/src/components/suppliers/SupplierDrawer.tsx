...
export const SupplierDrawer = ({
 ...
 <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-accent-base to-accent-base flex items-center justify-center text-white font-bold text-sm shadow-sm">
 {initials}
 </div>
 ...
 <div className="flex items-center gap-2.5 bg-surface-alt rounded-xl px-3.5 py-3">
 <User className="h-4 w-4 text-content-tertiary shrink-0" />
 ...
 <Package className="h-8 w-8 text-content-tertiary mx-auto mb-2.5" />
 ...
 <Package className="h-3.5 w-3.5 text-accent-base" />
 </div>
