...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  Technical: 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400',
  // Ukrainian categories
  '\u041F\u0440\u043E\u0434\u0443\u043A\u0442': 'bg-[var(--color-accent-light)] text-accent-base',
  '\u0411\u0456\u0437\u043D\u0435\u0441': 'bg-[var(--color-success-light)] text-success-base',
  '\u0422\u0435\u0445\u043D\u0456\u0447\u043D\u0435': 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400',
};
        ...
        {posts.map((post) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${CATEGORY_COLORS[post.category] ?? 'bg-surface-alt text-content-secondary'}`}>
                {post.category}
              </span>
              <time className="text-xs text-content-tertiary" dateTime={post.date}>
