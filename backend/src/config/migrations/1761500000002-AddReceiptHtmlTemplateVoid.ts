  ...
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "receipts" DROP COLUMN "void_reason"`);
    await queryRunner.query(`ALTER TABLE "receipts" DROP COLUMN "voided_at"`);
    await queryRunner.query(
      `ALTER TABLE "receipts" DROP COLUMN "template_version"`,
    );
    await queryRunner.query(`ALTER TABLE "receipts" DROP COLUMN "template_id"`);
    await queryRunner.query(
