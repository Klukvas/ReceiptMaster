...
export class UpdateCurrencyToUAH1700000000003 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "products" ALTER COLUMN "currency" SET DEFAULT 'UAH'`,
    );
    await queryRunner.query(
      `UPDATE "products" SET "currency" = 'UAH' WHERE "currency" = 'RUB'`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE "products" SET "currency" = 'RUB' WHERE "currency" = 'UAH'`,
    );
  }
}
